                        ...
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center">
                                ...
                                <div class="welcome-btn-group">
                                    <a href="/analyze" class="btn alazea-btn mr-30" style="border-radius: 25px">Analyze</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2>We Thrive To Build A Healthier Community Where Everyone Leads A Happy Life</h2>
                                <p><small>This planet is one of a kind that serves the apt conditiontions to lead a healthier and amazing life and gives everyone the rght to love themselves and take advantage of the vastly abailable flora around</small></p>
                                <div class="welcome-btn-group">
                                    <a href="/analyze" class="btn alazea-btn mr-30" style="border-radius: 25px">Analyze</a>
                                </div>
                            </div>
